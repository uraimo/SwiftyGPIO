...
let PWM_CHANNELS = 1
let NUM_ELEMENTS = 2000 //8x8 matrix, change this to what you want, but remember that different matrixes could have different connections between single leds
...
/*
leds: [UInt32] = ledsRandom(initial)
for i in 0...100 {
